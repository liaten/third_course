...
public class CorpAdapter extends RecyclerView.Adapter<CorpAdapter.ViewHolder> {
    ...
    private ArrayList corpID, corpName, corpFounders, corpProducts;

    CorpAdapter(Context context, ArrayList corpID, ArrayList corpName, ArrayList corpFounders, ArrayList corpProducts){
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView corpID_txt, corpName_txt, corpFounders_txt, corpProducts_txt;
