...
public class JsonEditActivity extends Activity {
    ListView StudentLV;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.json_edit_activity);
        ...
        adapter = new ArrayAdapter(JsonEditActivity.this, android.R.layout.simple_list_item_1,list);
    ...
    private final View.OnClickListener save_json_listener = view -> {
        ...
        try
        {
            ...
            Toast.makeText(JsonEditActivity.this,"Файл сохранен", Toast.LENGTH_SHORT).show();
        }
        catch (IOException ex)
        {
            Toast.makeText(JsonEditActivity.this, ex.getMessage(), Toast.LENGTH_SHORT).show();
        }
    };
